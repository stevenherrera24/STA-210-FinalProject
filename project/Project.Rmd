...
We see that the model predicts Roger Federer has a 76.7% chance of winning the match, while Novak Djokovic has a 91.38% chance of winning the match. This is mainly Djokovic's rank points were almost double that of Federer's. However, Federer won the match. 
...
```
We see that the model predicts Novak Djokovic has a 92.5% chance of winning the match, while Rafael Nadal has a 87.19% chance of winning the match. 

### Test Case with Similar Rank Points 

Now, we'll look at a match where both players had similar stats, especially rank points. The match we will look at is between Jo Wilfried Tsonga and Michael Llodra, and was played at the Queen's Club Championships in 2011. 
...
We see that the model predicts Jo Wilfried Tsonga has a 66.59% of chance of winning the match, while Michael Llodra has a 63.19% chance of winning the match. These percentages are slightly lower because their rankpoints are significantly lower than those of Nadal's or Djokovic's. 
