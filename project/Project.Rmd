...
To begin our exploratory data analysis, we will examine the matrix plot with all of the variables we said we would consider in our proposal.
...
The variables that we decided to remove are `mean_w_1stIn`, `mean_w_1stWon`, `mean_w_2ndWon`, `
