...
```{r}
finalhard <- lm(num ~ winner_age +winner_seed +winner_ht +winner_rank +aceCent +doubleFaultsCent +servicePercentageCent +firstServeInCent +firstServeWonCent +secondServeWonCent +savedGamesCent+breakPointSavedCent+breakPointFacedCent+minutesCent,data = hard)
